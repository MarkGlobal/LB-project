        ...
        <div class="row">
            ...
            <div class="main-site-logo clearfix">
                <a href="<?php echo get_home_url(); ?>">
                    <img src="<?php echo get_stylesheet_directory_uri(  ) . '/assets/images/LB_logo_bottom.png'; ?>">
                    <img src="<?php echo get_stylesheet_directory_uri(  ) . '/assets/images/LB_logo_top.png'; ?>">
            ...
            <button class=" menu mobile-menu-activate top force-green" onclick="this.setAttribute('aria-expanded', this.classList.contains('opened'))" aria-label="Main Menu">
                <svg width="70" height="65" viewBox="0 0 100 100">
...
<div class="banner" style="background-image: url('<?php echo esc_url($featured_img_url); ?> ')">
